          ...
          <div className="flex gap-10 w-[120%]">
            <div>
              <div className="relative group">
                <div className="bg-[#00ad9c] absolute w-full h-full z-[-8] bg-opacity-30 flex justify-center items-center rounded-xl group-hover:z-0 transition-all duration-500">
                  <div
                    className="bg-white p-3 rounded-full bg-opacity-50 cursor-pointer transform hover:scale-105 transition-all duration-500"
                    onClick={() => setCount(1)}
                  >
                ...
                <img
                  ...
                  alt="img"
                  className="mb-7 h-[400px] rounded-xl duration-500 transform hover:scale-105 transition-all"
                />
              </div>
              <hr />
            ...
            <div className="flex items-end relative">
              <div className="relative group">
                ...
                <img
                  ...
                  alt="img"
                  className="rounded-xl h-[400px] duration-500 transform hover:scale-105 transition-all"
                />
              </div>
            </div>
          </div>
          <div>
            ...
            <div className="flex items-center gap-9 mt-16 pb-28">
              <div className="flex items-center gap-3 text-white">
                <div className="flex group duration-300 cursor-pointer items-center font-semibold rounded-xl gap-5 border-[2px] border-[#00a795] bg-[#1a8377] hover:bg-[#00a795] py-3 px-5 transition-all duration-300 transform hover:scale-105">
                  <span>Portfolio</span>
                ...
                <div className="flex group duration-300 cursor-pointer items-center font-semibold rounded-xl gap-5 border-[2px] border-[#a9b7bf] hover:border-[#00a795] hover:bg-[#00a795] py-3 px-5 transition-all duration-300 transform hover:scale-105">
                  <span>Call</span>
                  <span>
                    <LuPhoneCall />
                  </span>
