    ...
    <div className="bg-[#1e1e20] pt-[100px]">
      <div className="container">
        ...
        <div className="py-[57px] px-[52px] rounded-lg text-white bg-[#2e2e30] gap-[20px] grid grid-cols-[2fr_1fr]">
          <div>
            <p className="text-[48px] leading-[120%] font-bold mb-[30px]">You can also be among this team :)</p>
            <p className="text-[#989899] font-medium">
              Do you want to grow with us? Now prove to us that you need it! Become an integral part of the team
            </p>
          </div>
          {/* Job openings list */}
